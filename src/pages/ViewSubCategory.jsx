...
export default function ViewSubCategory() {
     ...
     const deleteCategory = (categoryId) => {
          fetch(`http://localhost:3001/sub-categories/${categoryId}`, {
               method: "DELETE",
          })
               .then((response) => response.json())
               .then((data) => {
               ...
               <TableContainer component={Paper} className="full shadow-md">
                    <Table>
                         <TableHead className="bg-slate-800">
                              <TableRow>
                                   <TableCell className="text-white w-1/4">ID</TableCell>
                                   <TableCell className="text-white w-1/4">Category name</TableCell>
                                   <TableCell className="text-white w-1/4">
                                        Sub category name
                                   </TableCell>
                                   <TableCell className="text-white w-1/4">Actions</TableCell>
                              </TableRow>
                         </TableHead>
                         <TableBody>
